"""
Generates the 6 full pre-baked feeds (14-18 posts each) matching CBSE NCERT curriculum
for offline demo-mode and test fixtures.
"""
...
science_10_posts = [
    {
        ...
        "analogy": "",
        "quiz": None,
        "diagram": '<svg viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="180" x2="360" y2="180" stroke="#0f1e3d" stroke-width="4"/><line x1="200" y1="40" x2="200" y2="180" stroke="#4f6ba0" stroke-width="2" stroke-dasharray="6,4"/><text x="208" y="60" font-family="system-ui, sans-serif" font-size="12" fill="#4f6ba0" font-weight="600">Normal (N)</text><line x1="80" y1="70" x2="200" y2="180" stroke="#e63946" stroke-width="3"><animate attributeName="x2" values="80;200" dur="0.8s" fill="freeze"/></line><text x="70" y="65" font-family="system-ui, sans-serif" font-size="12" fill="#e63946" font-weight="600">Incident Ray (i)</text><line x1="200" y1="180" x2="320" y2="70" stroke="#22c55e" stroke-width="3"><animate attributeName="x2" values="200;320" dur="0.8s" begin="0.8s" fill="freeze"/></line><text x="280" y="65" font-family="system-ui, sans-serif" font-size="12" fill="#22c55e" font-weight="600">Reflected Ray (r)</text></svg>',
    ...
    },
    {
        ...
        "quiz": None,
        "diagram": '<svg viewBox="0 0 400 220" xmlns="http://www.w3.org/2000/svg"><rect x="30" y="20" width="340" height="90" fill="#f7f9fc" stroke="#d7e0f0"/><text x="45" y="45" fill="#4f6ba0" font-size="12" font-weight="700">Air (Faster Medium)</text><rect x="30" y="110" width="340" height="90" fill="#eef3fc" stroke="#d7e0f0"/><text x="45" y="135" fill="#1e3a6b" font-size="12" font-weight="700">Glass (Denser Medium)</text><line x1="100" y1="30" x2="200" y2="110" stroke="#e63946" stroke-width="3"/><line x1="200" y1="110" x2="260" y2="190" stroke="#22c55e" stroke-width="3"/><line x1="200" y1="40" x2="200" y2="180" stroke="#4f6ba0" stroke-width="1.5" stroke-dasharray="4,4"/></svg>',
    ...
    },
    {
        ...
        "analogy": "",
        "quiz": None,
        "diagram": '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><line x1="30" y1="100" x2="370" y2="100" stroke="#0f1e3d" stroke-width="2"/><path d="M 320,30 Q 350,100 320,170" fill="none" stroke="#1e3a6b" stroke-width="4"/><circle cx="340" cy="100" r="4" fill="#0f1e3d"/><text x="345" y="120" font-size="12" fill="#0f1e3d" font-weight="700">P</text><circle cx="230" cy="100" r="4" fill="#22c55e"/><text x="225" y="125" font-size="12" fill="#22c55e" font-weight="700">F</text><circle cx="120" cy="100" r="4" fill="#e63946"/><text x="115" y="125" font-size="12" fill="#e63946" font-weight="700">C</text><line x1="120" y1="85" x2="340" y2="85" stroke="#e63946" stroke-width="1.5"/><text x="220" y="80" font-size="11" fill="#e63946" text-anchor="middle">R = 2f</text></svg>',
    ...
    },
    {
        ...
        "analogy": "",
        "quiz": None,
        "diagram": '<svg viewBox="0 0 380 200" xmlns="http://www.w3.org/2000/svg"><rect x="30" y="20" width="150" height="150" rx="10" fill="#f7f9fc" stroke="#1e3a6b" stroke-width="2"/><text x="105" y="55" fill="#1e3a6b" font-weight="bold" font-size="14" text-anchor="middle">MIRROR</text><text x="105" y="95" fill="#0f1e3d" font-size="13" text-anchor="middle">1/v + 1/u = 1/f</text><text x="105" y="130" fill="#e63946" font-size="13" text-anchor="middle">m = -v/u</text><rect x="200" y="20" width="150" height="150" rx="10" fill="#f7f9fc" stroke="#22c55e" stroke-width="2"/><text x="275" y="55" fill="#22c55e" font-weight="bold" font-size="14" text-anchor="middle">LENS</text><text x="275" y="95" fill="#0f1e3d" font-size="13" text-anchor="middle">1/v - 1/u = 1/f</text><text x="275" y="130" fill="#22c55e" font-size="13" text-anchor="middle">m = +v/u</text></svg>',
...
FEEDS = {
    "science-10-light.json": science_10_posts,
}

# Also generate electricity, parabola, trigonometry, nationalism, resources feeds
# Let's read existing demo feeds or generate complete curated feeds
for filename, posts in FEEDS.items():
...
print("Pre-baked feed build complete.")
