...
export const SAMPLE_FEEDS = {
  ...
  <circle cx="200" cy="110" r="4" fill="#e63946"/>
      ...
      },
      {
        ...
        body: "The mirror formula connects object distance ($u$), image distance ($v$), and focal length ($f$):\n\n$$\\frac{1}{v} + \\frac{1}{u} = \\frac{1}{f}$$\n\nNew Cartesian rule: Object distance $u$ is ALWAYS negative ($-u$) because incident light travels from left to right.",
        analogy: "",
        quiz: null,
        diagram: `<svg viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="40" y="30" width="160" height="36" rx="8" fill="#0f1e3d"/>
  <text x="50" y="53" font-family="system-ui, sans-serif" font-size="14" fill="#ffffff" font-weight="800">1/v + 1/u = 1/f</text>
</svg>`,
      ...
      },
      {
        ...
        body: "Review before refraction:\n1. Concave mirrors converge rays; concave focal length is NEGATIVE ($-f$).\n2. Convex mirrors diverge rays; convex focal length is POSITIVE ($+f$).\n3. Magnification:\n$$m = -\\frac{v}{u} = \\frac{h_i}{h_o}$$",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "When a ray emerges from a rectangular glass slab, the emergent ray is parallel to the incident ray but laterally displaced. The angle of emergence equals the angle of incidence ($\\angle i = \\angle e$).",
        analogy: "",
        quiz: null,
        diagram: `<svg viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="210" y="200" font-family="system-ui, sans-serif" font-size="11" fill="#22c55e" font-weight="700">Emergent Ray (|| Incident)</text>
      ...
      },
      {
        ...
        body: "In Board exams, over 30% of students lose 3 marks by confusing the sign!\n\n• Mirror Formula (PLUS):\n$$\\frac{1}{v} + \\frac{1}{u} = \\frac{1}{f}$$\n\n• Lens Formula (MINUS):\n$$\\frac{1}{v} - \\frac{1}{u} = \\frac{1}{f}$$",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        analogy: "",
        quiz: {
          question: "A doctor prescribes a corrective lens of power $P = -2.0\\text{ D}$. What is its focal length $f$ and lens type?",
          options: [
          ...
          correct_index: 0,
          explanation: "Power $P = \\frac{1}{f\\text{ (m)}}$. Hence $f = \\frac{1}{P} = \\frac{1}{-2.0} = -0.5\\text{ m}$. Negative focal length and power always indicate a concave (diverging) lens used for correcting myopia."
        },
        diagram: "",
      ...
      },
      {
        ...
        body: "Absolute refractive index:\n\n$$n = \\frac{c}{v}$$\n\nwhere $c$ is speed of light in vacuum ($3 \\times 10^8\\text{ m/s}$) and $v$ is speed in the medium. Higher refractive index = optically denser medium = slower speed of light.",
        analogy: "",
        quiz: null,
        diagram: `<svg viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="70" y="175" font-family="system-ui, sans-serif" font-size="14" fill="#0f1e3d" font-weight="600">Diamond has highest n = 2.42</text>
      ...
      },
      {
        ...
        body: "Key points so far:\n1. Convex lens converges; focal length $f$ is POSITIVE ($+f$).\n2. Concave lens diverges; focal length $f$ is NEGATIVE ($-f$).\n3. Power: $$P = \\frac{1}{f\\text{ (in meters)}}$$\n4. Diamond has highest refractive index ($n = 2.42$).",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "Congratulations! You completed the 15-card Light module.\n\n• Mirror Formula: $\\frac{1}{v} + \\frac{1}{u} = \\frac{1}{f}$\n• Lens Formula: $\\frac{1}{v} - \\frac{1}{u} = \\frac{1}{f}$\n• Concave focal length $f < 0$, Convex focal length $f > 0$\n• Power: $P = \\frac{1}{f\\text{ (m)}}$ (in Dioptres).",
        analogy: "",
        quiz: null,
        diagram: "",
    ...
    posts: [
      {
        ...
        body: "Electric current is the rate of flow of electric charges:\n\n$$I = \\frac{Q}{t}$$\n\n1 Ampere corresponds to 1 Coulomb passing per second ($6.25 \\times 10^{18}$ electrons). Conventional current flows from positive to negative terminal, opposite to electron motion.",
        analogy: "",
        quiz: null,
  ...
  <text x="175" y="210" font-family="sans-serif" font-size="11" font-weight="700" fill="#0f1e3d">Battery (V)</text>
      ...
      },
      {
        ...
        body: "Water only flows down a pipe when there is a pressure difference created by an overhead Sintex tank. Similarly, electrons cannot move through a copper wire without electric pressure (Potential Difference $V = \\frac{W}{Q}$) generated by chemical reactions inside a battery cell.",
      ...
      },
      {
        ...
        body: "At constant temperature, current $I$ passing through a metallic conductor is directly proportional to the potential difference $V$ across its ends:\n\n$$V = IR$$\n\nOn a graph of $V$ (y-axis) vs $I$ (x-axis), the slope is equal to Resistance: $$R = \\frac{\\Delta V}{\\Delta I}$$",
        analogy: "",
        quiz: null,
        diagram: `<svg viewBox="0 0 400 220" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="60" cy="180" r="4" fill="#0f1e3d"/>
      ...
      },
      {
        ...
        quiz: {
          ...
          correct_index: 0,
          explanation: "Volume $V = A \\times L$ remains constant. If length doubles ($L' = 2L$), area halves ($A' = A/2$). Since $R = \\rho \\frac{L}{A}$, $R' = \\rho \\frac{2L}{A/2} = 4\\left(\\rho \\frac{L}{A}\\right) = 4R$."
        },
        diagram: "",
      ...
      },
      {
        ...
        body: "Why is Tungsten used in incandescent lamps while Nichrome is used in geysers & electric irons? Tungsten has an ultra-high melting point ($3380^\\circ\\text{C}$) to glow white without melting. Nichrome has high resistivity and does NOT oxidize (burn) even at red-hot temperatures.",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "Crucial CBSE distinction:\n\n• In Series, Current $I$ is identical across each resistor:\n$$R_s = R_1 + R_2 + R_3$$\n\n• In Parallel, Voltage $V$ is identical across each branch:\n$$\\frac{1}{R_p} = \\frac{1}{R_1} + \\frac{1}{R_2} + \\frac{1}{R_3}$$\n\nParallel combination always yields equivalent resistance SMALLER than the smallest individual resistor.",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "CBSE board-exam trap alert:\n\n• Ammeter has very low resistance and MUST always be connected in SERIES.\n• Voltmeter has high resistance and MUST always be connected in PARALLEL across the component.\n\nReversing them burns out sensitive circuits or reads zero!",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "The heat $H$ produced in a resistor of resistance $R$ carrying current $I$ for time $t$ is given by:\n\n$$H = I^2 R t = V I t = \\frac{V^2}{R} t$$\n\nNote: Heat is proportional to the square of current ($I^2$), so doubling current quadruples heat output!",
        analogy: "",
        quiz: null,
        diagram: "",
    ...
    posts: [
      {
        ...
        body: "A parabola is the locus of a point whose distance from a fixed point (focus) equals its distance from a fixed straight line (directrix):\n\n$$y^2 = 4ax$$\n\nStrictly, the eccentricity is $e = 1$.",
        analogy: "",
        quiz: null,
        diagram: `<svg viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="60" y="45" font-family="system-ui, sans-serif" font-size="11" fill="#e63946" font-weight="700">x = -a</text>
      ...
      },
      {
        ...
        body: "For the parabola $y^2 = 4ax$, the chord passing through the focus perpendicular to the axis is the latus rectum:\n\n$$\\text{Length of Latus Rectum} = 4a$$\n\nThe focal distance of any point $P(x_1, y_1)$ on the parabola is:\n\n$$SP = x_1 + a$$",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        analogy: "",
        quiz: {
          question: "What are the coordinates of the focus of the parabola $x^2 = -16y$?",
          options: [
            "(0, -4)",
            "(-4, 0)",
            "(0, 4)",
          ...
          correct_index: 0,
          explanation: "Compare with standard vertical downward form $x^2 = -4ay$. Here $4a = 16 \\implies a = 4$. The axis is along the y-axis opening downwards, so the focus is at $(0, -a) = (0, -4)$."
        },
        diagram: "",
      ...
      },
      {
        ...
        body: "When given $(y - k)^2 = 4a(x - h)$, do NOT assume focus is $(a, 0)$! The vertex has shifted to $(h, k)$.\n\n• New Focus: $(h + a, k)$\n• New Directrix: $x = h - a$",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "Summary:\n1. $y^2 = 4ax$: opens RIGHT, focus $(a, 0)$.\n2. $y^2 = -4ax$: opens LEFT, focus $(-a, 0)$.\n3. $x^2 = 4ay$: opens UP, focus $(0, a)$.\n4. $x^2 = -4ay$: opens DOWN, focus $(0, -a)$.",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "Any point on $y^2 = 4ax$ can be expressed in terms of parameter $t$ as:\n\n$$x = at^2, \\quad y = 2at$$\n\nThis simplifies tangent and normal equations dramatically!",
        analogy: "",
        quiz: null,
        diagram: "",
      ...
      },
      {
        ...
        body: "Area bounded by $y^2 = 4ax$ and its latus rectum $x = a$ is exactly:\n\n$$\\text{Area} = \\frac{8}{3}a^2$$\n\nIn Board 5-mark questions, show the full integration steps:\n$$\\int_0^a 2\\sqrt{4ax}\\,dx = \\frac{8}{3}a^2$$\nUse this shortcut to verify your result instantly.",
        analogy: "",
        quiz: null,
        diagram: "",
