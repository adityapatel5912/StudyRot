...
export function AuthProvider({ children }) {
  ...
  const [demoMode, setDemoMode] = useState(true); // Default ON as requested
  const [savedKeysStatus, setSavedKeysStatus] = useState({ has_groq: false, has_tavily: false });

  // Check initial session
  useEffect(() => {
    // Check if user was previously signed in (localStorage or Supabase)
  ...
  const signInWithGoogle = async () => {
    ...
    // High-fidelity Google Demo User for hackathon evaluation
