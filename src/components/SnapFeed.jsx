...
export default function SnapFeed({
  ...
  return (
    <main className="snap-feed-container" ref={containerRef} tabIndex={0} aria-label="CBSE NCERT Scrollable Feed">
      {/* Top Floating Control Bar */}
      <nav className="top-counter-bar" aria-label="Feed Controls">
      ...
      {/* Snap Scrollable Post Cards with Lazy Rendering and Error Boundary */}
      {posts.map((post, idx) => {
        // Performance optimization: only mount active card and its direct neighbors
